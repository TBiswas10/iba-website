        ...
        <div className="event-details-meta">
          <div className="event-detail-row">
            ...
            <span className="event-detail-value">
              {new Date(event.start).toLocaleDateString("en-AU", { weekday: "long", day: "numeric", month: "long", year: "numeric" })}
            </span>
          </div>
          ...
          <div className="event-detail-row">
            ...
            <span className="event-detail-value">
              {new Date(event.start).toLocaleTimeString("en-AU", { hour: "numeric", minute: "2-digit" })} - {new Date(event.end).toLocaleTimeString("en-AU", { hour: "numeric", minute: "2-digit" })}
            </span>
          </div>
